...
// node_modules/@rehaps/rehaps-web-components/dist/esm/rwc-slides.entry.js
var slidesCss, RwcSlides;
var init_rwc_slides_entry = __esm({
  "node_modules/@rehaps/rehaps-web-components/dist/esm/rwc-slides.entry.js"() {
    init_index_e9508d80();
    init_eventManager_f421930c();
    init_rwcActionHelper_202b4497();
    slidesCss = '@font-face{font-family:"Inter";font-style:normal;font-weight:400;font-display:swap;src:url("assets/fonts/inter/Inter-Regular.woff2?v=1.0") format("woff2"), url("assets/fonts/inter/Inter-Regular.woff?v=1.0") format("woff")}@font-face{font-family:"Inter";font-style:normal;font-weight:500;font-display:swap;src:url("assets/fonts/inter/Inter-Medium.woff2?v=1.0") format("woff2"), url("assets/fonts/inter/Inter-Medium.woff?v=1.0") format("woff")}@font-face{font-family:"Inter";font-style:normal;font-weight:600;font-display:swap;src:url("assets/fonts/inter/Inter-SemiBold.woff2?v=1.0") format("woff2"), url("assets/fonts/inter/Inter-SemiBold.woff?v=1.0") format("woff")}:host{--slides-animation-duration:200ms;--slides-slide-fade-transition:opacity var(--slides-animation-duration) ease-in-out,\n    visibility 0ms linear var(--slides-animation-duration),\n    position 0ms linear var(--slides-animation-duration),\n    left 0ms linear var(--slides-animation-duration);--slides-slide-active-fade-transition:opacity var(--slides-animation-duration) ease-in-out var(--slides-animation-duration),\n    visibility 0ms linear var(--slides-animation-duration),\n    position 0ms linear var(--slides-animation-duration),\n    left 0ms linear var(--slides-animation-duration);display:block}.container{width:100%;overflow-x:hidden;position:relative}.slide-flex{display:flex;flex-direction:row}.slide-wrapper{width:100%}::slotted(*){left:-99999px;opacity:0;position:absolute;transition:var(--slides-slide-fade-transition);visibility:hidden}::slotted(.active){left:0;opacity:1;position:unset;transition:var(--slides-slide-active-fade-transition);visibility:visible}';
    RwcSlides = class {
      constructor(hostRef) {
...
init_rwc_slides_entry();
export {
  RwcSlides as rwc_slides
};
//# sourceMappingURL=rwc-slides.entry-YCFGQXD4.js.map
