...
var init_rwc_system_notifications_entry = __esm({
  "node_modules/@rehaps/rehaps-web-components/dist/esm/rwc-system-notifications.entry.js"() {
    ...
    RwcSystemNotification = class {
      ...
      onWindowResize() {
        this.notificationContainerElement.querySelectorAll(".notification-wrapper").forEach((wrapper) => {
    ...
    RwcSystemNotification.style = systemNotificationsCss;
  }
});
init_rwc_system_notifications_entry();
export {
  RwcSystemNotification as rwc_system_notifications
};
//# sourceMappingURL=rwc-system-notifications.entry-SVI3TBR3.js.map
