...
var init_rwc_modal_entry = __esm({
  "node_modules/@rehaps/rehaps-web-components/dist/esm/rwc-modal.entry.js"() {
    ...
    RwcModal = class {
      ...
      get currentOpacity() {
        var _a;
        return Number.parseFloat(((_a = this.rootElement) === null || _a === void 0 ? void 0 : _a.style.opacity) || getComputedStyle(this.rootElement).opacity);
      }
      ...
      falloffClick(event) {
        if (!this.innerContainer.contains(event.target) && !this.host.contains(event.target)) {
          this.close();
        }
      }
      renderHeaderHtml() {
...
init_rwc_modal_entry();
export {
  RwcModal as rwc_modal
};
//# sourceMappingURL=rwc-modal.entry-PO224QI6.js.map
