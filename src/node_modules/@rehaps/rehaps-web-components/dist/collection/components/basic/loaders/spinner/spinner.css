...
:host {
  /**
   * @prop --spinner-color: The color of the spinner.
   * @prop --spinner-size: The size of the spinner.
   */
...
.spinner {
  ...
  aspect-ratio: 1;
  border-radius: 50%;
  background: radial-gradient(farthest-side, var(--spinner-color), rgba(0, 0, 0, 0)) top/8px 8px no-repeat, conic-gradient(rgba(0, 0, 0, 0) 30%, var(--spinner-color));
