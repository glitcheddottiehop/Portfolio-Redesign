...
:host {
  ...
  */
  ...
  --info-card-border-color: rgb(224, 224, 224);
  --info-card-hover-border-color: rgb(144, 238, 144);
  --info-card-border-radius: 0.75rem;
  ...
  --info-card-box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1);
  --info-card-box-shadow-animated-hover: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1);
  --info-card-container-transition: box-shadow 0.4s ease-in-out;
  --info-card-inner-padding: 1rem;
  --info-card-icon-size: 2.5rem;
  --info-card-icon-margin-after: 1rem;
  --info-card-icon-color: rgb(117, 117, 117);
  display: block;
}
