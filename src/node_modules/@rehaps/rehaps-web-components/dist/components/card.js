...
const RwcCard = proxyCustomElement(class RwcCard extends HTMLElement {
  ...
  render() {
    return (h("div", { class: {
        container: true,
        'animate-border': this.animateBorder,
...
function defineCustomElement() {
  ...
  const components = ["rwc-card"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcCard);
      }
      break;
  } });
}

export { RwcCard as R, defineCustomElement as d };
