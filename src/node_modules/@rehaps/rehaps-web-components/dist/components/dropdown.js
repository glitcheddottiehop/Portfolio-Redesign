...
const RwcDropdown = proxyCustomElement(class RwcDropdown extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.dropdownOpenEvent = createEvent(this, "dropdownOpen", 7);
    this.dropdownCloseEvent = createEvent(this, "dropdownClose", 7);
  ...
  static get style() { return dropdownCss; }
    ...
    "init": [64],
    "setState": [64]
  }, [[9, "scroll", "onWindowScroll"], [9, "resize", "onWindowResize"], [4, "click", "onDocumentClick"]]]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rwc-dropdown"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-dropdown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcDropdown);
      }
      break;
  } });
}

export { RwcDropdown as R, defineCustomElement as d };
