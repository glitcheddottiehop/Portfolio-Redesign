...
const Container = proxyCustomElement(class Container extends HTMLElement {
  ...
  static get style() { return containerCss; }
    ...
    "scrollIntoAnimation": [1, "scroll-into-animation"],
    "scrollOutAnimation": [1, "scroll-out-animation"],
    "animateOpacity": [4, "animate-opacity"],
    "animationDuration": [514, "animation-duration"],
    "visibilityThreshold": [2, "visibility-threshold"],
    "isVisible": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rwc-container"];
...
const RwcContainer = Container;
const defineCustomElement = defineCustomElement$1;

export { RwcContainer, defineCustomElement };

//# sourceMappingURL=rwc-container.js.map