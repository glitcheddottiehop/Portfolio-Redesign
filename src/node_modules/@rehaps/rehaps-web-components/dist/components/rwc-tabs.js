...
const RwcTabs$1 = proxyCustomElement(class RwcTabs extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
RwcTabs$1.ACTIVE_TAB_CLASS = 'active';
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rwc-tabs"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-tabs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcTabs$1);
      }
      break;
  } });
}

const RwcTabs = RwcTabs$1;
const defineCustomElement = defineCustomElement$1;

export { RwcTabs, defineCustomElement };

//# sourceMappingURL=rwc-tabs.js.map