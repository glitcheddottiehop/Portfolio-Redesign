...
const RwcButton$1 = proxyCustomElement(class RwcButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return buttonCss; }
    ...
    "showIconRight": [4, "show-icon-right"],
    "iconLeft": [1, "icon-left"],
    "showIconLeft": [4, "show-icon-left"],
    "type": [513],
    "theme": [513],
    "width": [1],
    "ripple": [4],
    "renderShadow": [4, "render-shadow"]
  }, [[0, "click", "onButtonClick"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rwc-button"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcButton$1);
      }
      break;
  } });
}

const RwcButton = RwcButton$1;
const defineCustomElement = defineCustomElement$1;

export { RwcButton, defineCustomElement };

//# sourceMappingURL=rwc-button.js.map