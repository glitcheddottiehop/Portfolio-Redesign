...
import { A as AccountIcon } from './account_circle.js';
...
const RwcUserCard$1 = proxyCustomElement(class RwcUserCard extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return userCardCss; }
}, [1, "rwc-user-card", {
    "avatar": [513],
    "roundedAvatar": [4, "rounded-avatar"],
    "renderShadow": [516, "render-shadow"],
    "renderBorder": [516, "render-border"],
    "animateBorder": [516, "animate-border"],
    "locationIcon": [513, "location-icon"],
    "ratingIcon": [513, "rating-icon"],
    "pointer": [4]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rwc-user-card", "rwc-card"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-user-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcUserCard$1);
      }
      break;
    case "rwc-card":
      if (!customElements.get(tagName)) {
...
const RwcUserCard = RwcUserCard$1;
const defineCustomElement = defineCustomElement$1;

export { RwcUserCard, defineCustomElement };

//# sourceMappingURL=rwc-user-card.js.map