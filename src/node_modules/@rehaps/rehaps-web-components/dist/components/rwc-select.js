...
import { d as defineCustomElement$2 } from './dropdown.js';
...
const RwcSelect$1 = proxyCustomElement(class RwcSelect extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return selectCss; }
    ...
    "isOpen": [32],
    "setValue": [64]
  }, [[0, "click", "onSelectClick"], [0, "dropdownOpen", "onDropdownOpen"], [0, "dropdownClose", "onDropdownClose"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rwc-select", "rwc-dropdown"];
  components.forEach(tagName => { switch (tagName) {
    case "rwc-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RwcSelect$1);
      }
      break;
    case "rwc-dropdown":
      if (!customElements.get(tagName)) {
...
const RwcSelect = RwcSelect$1;
const defineCustomElement = defineCustomElement$1;

export { RwcSelect, defineCustomElement };

//# sourceMappingURL=rwc-select.js.map