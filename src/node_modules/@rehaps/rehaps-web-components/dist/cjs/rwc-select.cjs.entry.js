...
const RwcSelect = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("div", { class: "wrapper" }, index.h("div", { class: "value" }, this.text), index.h("div", { slot: "right", class: {
        rotate: true,
        open: this.isOpen
      } }, index.h("slot", { name: "icon-right" }, this.renderIcon()))), index.h("rwc-dropdown", { class: "dropdown", "open-mode": "toggle", size: "parent", mode: 'fixed', ref: (dropdown) => this.dropdownElement = dropdown }, index.h("slot", { name: "option", ref: (slot) => this.optionsSlot = slot })))));
  }
  renderIcon() {
    if (this.icon) {
      return (index.h("img", { src: this.icon, alt: "icon" }));
    }
    return (index.h("div", { innerHTML: ChevronDown, class: "icon svg-icon" }));
  }
};
RwcSelect.style = selectCss;

exports.rwc_select = RwcSelect;

//# sourceMappingURL=rwc-select.cjs.entry.js.map