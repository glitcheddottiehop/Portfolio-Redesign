...
const RwcSystemNotification = class {
  constructor(hostRef) {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { ref: (element) => (this.notificationContainerElement = element), class: "container" }, this.renderNotifications())));
  }
  renderNotifications() {
    var _a;
    const notificationElements = [];
    for (const [notification, _timeout] of this.notifications) {
      notificationElements.push(index.h("div", { class: {
          ["notification-wrapper"]: true,
          closing: notification.closing,
        }, key: notification.key, "data-key": notification.key, onMouseEnter: () => this.unsetAutoRemoveByReference(notification), onMouseLeave: () => this.initAutoRemove(notification) }, index.h("div", { class: {
          notification: true,
          [(_a = notification.type) !== null && _a !== void 0 ? _a : "info"]: true,
        } }, this.renderCloseIcon(notification), notification.title && index.h("p", { class: "title" }, notification.title), notification.message && (index.h("p", { class: "message" }, notification.message)))));
    }
    return notificationElements;
  }
  renderCloseIcon(notification) {
    if (notification.closable) {
      return (index.h("div", { class: "close-icon", innerHTML: close.Close, onClick: () => this.removeNotificationByReference(notification) }));
    }
...
exports.rwc_system_notifications = RwcSystemNotification;

//# sourceMappingURL=rwc-system-notifications.cjs.entry.js.map