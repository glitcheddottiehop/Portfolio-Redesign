...
const RwcFoldingSquares = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
  }
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "folding-cube" }, index.h("div", { class: "cube1 cube" }), index.h("div", { class: "cube2 cube" }), index.h("div", { class: "cube4 cube" }), index.h("div", { class: "cube3 cube" }))));
  }
};
RwcFoldingSquares.style = foldingSquaresCss;

exports.rwc_folding_squares = RwcFoldingSquares;

//# sourceMappingURL=rwc-folding-squares.cjs.entry.js.map